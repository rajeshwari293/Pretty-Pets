            ...
            while($row=$stmt->fetch(PDO::FETCH_ASSOC)){
                ...
                <div class="col-md-6">
                    <div class="product-dtl">
                            ...
                            <div class="product-name">Breed:<?= $row['breed_name'] ?></div>
                            <div class="reviews-counter">
                                
                            <div class="product-price-discount">Price:<span>₹<?= $row['pet_price'] ?></span></div>
                            ...
                            <div ><b>Age: </b> <span><?php echo $diff->y." Year ".$diff->m." month ".$diff->d." days " ?></span></div><br>

                            <div ><b>Description: </b><span><p><?php echo $row['pet_desc'] ?></p></span></div>
                            <span></span>
                            <div ><b>Price:</b>  <span>₹<?php echo $row['pet_price'] ?></span></div>
                            <div ><b>:</b>  <span>₹<?php echo $row['pet_price'] ?></span></div>
                        </div>
