...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                <h6 class="text-primary text-uppercase">OTP PAGE</h6>
	...
	<center><div class="form sign-in">
			  <h1><center> <b><span class="multicolortext"></span></center></b></h1>
			   ...
			   <h4 style="margin-top:152px"><center>Enter your OTP</center></h4>
			  <label>
				
			<input type="number" class="form-control bg-light border-0 px-4" name="otp" style="width:200px;height: 30px;"></p>
			  </label>
